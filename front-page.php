...
<li><a href="https://biosolve4all.com/noticias/">Notícias</a></li>
...
<span class="sib-form-message-panel__inner-text">
                            A sua assinatura não pode ser validada.
                        </span>
</div>
</div>
<div></div>
...
<span class="sib-form-message-panel__inner-text">
                            Você fez a sua assinatura com sucesso.
                        </span>
</div>
</div>
<div></div>
...
<label class="entry__label" data-required="*" for="EMAIL" style="font-weight: 700; text-align:left; font-size:16px; text-align:left; font-weight:700; font-family:Figtree, sans-serif; color:#33617a;">Insira o seu e-mail para fazer a sua assinatura</label>
...
<span class="checkbox checkbox_tick_positive" style="margin-left:"></span><span style="font-size:14px; text-align:left; font-family:Figtree, sans-serif; color:#3C4858; background-color:transparent;"><p>Eu concordo em receber newsletters com os seus devidos termos e condições.</p><p><br/></p></span> </input></label>
</div>
</div>
<label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; font-family:Figtree, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;">
</label>
